...
const makeBody = (searchQuery) => {
  return encodeURIComponent(`Suggested Keyword: ${searchQuery}\nSuggested Destination Page: TODO - FILL ME IN\n`)
}
...
export default ({searchQuery}) => (
  <li className="zeroState">
    ...
    <div className="ctas">
      <A className="button" href={`https://github.com/kj800x/nulinks/issues/new?title=${makeTitle(searchQuery)}&body=${makeBody(searchQuery)}`}>Make a Suggestion</A>
    </div>
  </li>
)

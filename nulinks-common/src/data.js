const NULINKS_DATA = [
  ...
  },
  {
    ...
    "description": "Book an appointment with an advisor (co-op, academic, career, drc)",
  ...
  },
  {
    ...
    "description": "Your resource for housing and relocation services beyond Boston",
    "usageFrequency": "ONCE A YEAR"
  },
  {
  ...
  {
    "keywords": ["sfs-financial-aid", "financial-aid", "financial-aid-status", "finaid"],
  ...
  },
  {
    ...
    "description": "Fill out workstudy timesheets and search and apply for part-time student employment opportunities including Federal Work-Study positions",
    "usageFrequency": "A FEW TIMES A WEEK"
  },
  {
    "keywords": ["student-employee-self-service", "student-employment-taxes", "workstudy-taxes", "w-2", "w-4", "taxes", "benefits", "pay-information"],
  ...
  {
    "keywords": ["erezlife", "roommate-agreement", "ereslife", "ezrezlife", "ezreslife", "reslife", "rezlife"],
    "title": "eRezLife",
  ...
  {
    "keywords": ["fp", "floor-plans", "floorplans", "housing-floor-plans", "housing-rooms"],
